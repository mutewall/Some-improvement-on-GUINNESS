...
import link_integer_conv2d as DC
...
class CNN(chainer.Chain):
    def __init__(self):
        super(CNN, self).__init__(
            ...
            conv1=DC.Convolution2D(64,128,3, stride=2, pad=1, nobias=False),
            ...
            conv2=DC.Convolution2D(128,256,3, stride=2, pad=1, nobias=False),
            ...
            conv3=DC.Convolution2D(256,512,3, stride=2, pad=1, nobias=False),
            ...
            conv4=DC.Convolution2D(512,1024,3, stride=2, pad=1, nobias=False),
            b_conv4=L.BatchNormalization(1024),
            fc0=DL.DorefaLinear(1024,1050),
            b_dense0=L.BatchNormalization(1050),
            fc1=L.Linear(1050,5),
    ...
    def __call__(self, x, train):
        ...
        h = self.b_conv4(da.dst(self.conv4(h)))
        h = F.max_pooling_2d(h, h.shape[2:])
        h = self.b_dense0(da.dst(self.fc0(h)))
        #pdb.set_trace()
        h = self.fc1(h)
        #pdb.set_trace()
        return h
