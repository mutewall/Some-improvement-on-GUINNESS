...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', '-m', type=str, default='bincnn', choices=['bincnn','cnn'],
                        help='Model name')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.00001,
                        help='Weight decay')
    parser.add_argument('--optimizer', type=str, default='sgd', choices=['sgd', 'adam', 'momentum', 'rmsprop'],
                        help='Optimizer name')
    ...
    parser.add_argument('--resume', type=str, default='n',
...
#        if len(lr_decay_iter) == 1 and (epoch + 1) % lr_decay_iter[0] == 0 or epoch + 1 in lr_decay_iter:
    ...
    if args.resume == 'no':
        ...
        with open(log_file_path, 'w') as f:
            f.write('epoch,train loss,train error,valid loss,valid error,test loss,test error\n')
    else:
